...
<body>
	...
	<section>
		...
		<div class="fig-one-img">
			...
			<div class="fig-one-img-title-2">
				<?php $post_id = 22; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-one-img-content-1">
				<?php $post_id = 24; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-one-img-content-2">
				<?php $post_id = 28; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
		...
		<div class="fig-two-img">
			...
			<div class="fig-two-img-title-2">
				<?php $post_id = 49; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-two-img-content-1">
				<?php $post_id = 51; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?><br/><br/><hr>
					<a href="#">
		...
		<div class="fig-three-img">
			...
			<div class="fig-three-img-title-2">
				<?php $post_id = 62; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-three-img-content-1">
				<?php $post_id = 64; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-three-img-content-2">
				<?php $post_id = 66; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?><br/><br/><hr>
				<a href="#">
		...
		<div class="fig-four-img">
			...
			<div class="fig-four-img-title-2">
				<?php $post_id = 82; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-four-img-content-1">
				<?php $post_id = 84; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div><br/>
			<div class="fig-four-img-content-2">
				<?php $post_id = 86; 
				$queried_post = get_post($post_id); 
		...
		<div class="fig-five-img">
			...
			<div class="fig-five-img-title-2">
				<?php $post_id = 97; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-five-img-title-3">
				<?php $post_id = 98; 
				$queried_post = get_post($post_id); 
				echo $queried_post->post_content;?>
			</div>
			<div class="fig-five-img-content-1">
				<?php $post_id = 101; 
				$queried_post = get_post($post_id); 
		...
		<div class="footerimg">
			<div class="treeimg"></div>
			<div class="bird1pic"></div>
			<div class="bird2pic"></div>
			<div class="cho1img"></div>
